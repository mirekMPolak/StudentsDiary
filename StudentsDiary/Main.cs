...
namespace StudentsDiary
{
    ...
    {
        private readonly FileHelper<List<Student>> _fileHelper = new FileHelper<List<Student>>(Program.FilePath);
        ...
        private void RefreshDiary()
        {
            ...
            if (cbGroupsFiltering.SelectedItem.ToString() == "Wszyscy")
            {
                dgvDiary.DataSource = students;
            }
            else
            {
                dgvDiary.DataSource = students.Where(x => x.GroupId == cbGroupsFiltering.SelectedItem.ToString()).ToList();
            }
        }
        ...
        private void SetCbGroupsFiltering(string filter)
        {
            cbGroupsFiltering.SelectedItem = filter;
        }
    }
}
